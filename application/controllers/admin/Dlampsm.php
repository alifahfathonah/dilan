...
class Dlampsm extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('admin/d_lampsm/view', $data);
    ...
    function list($ush)
    {
        ...
        $data['usaha'] = $this->mod_lampsm->selectsm_usaha($id)->result_array();
        ...
        $this->load->view('admin/template/navbar', $data);
        $this->load->view('admin/template/sidebar', $data);
        $this->load->view('admin/d_lampsm/view_d', $data);
        $this->load->view('admin/template/footer');
    }
}
