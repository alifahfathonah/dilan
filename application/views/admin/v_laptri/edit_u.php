...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Update Laporan Triwulan</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <form role="form" method="post" action="<?= base_url('admin/v_laptri/edit'); ?>">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="date1" class="form-control form-control-sm col-6" value="<?= $laptri['tahun_t']; ?>" type="text" name="tahun" readonly="">
