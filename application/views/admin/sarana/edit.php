...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <form role="form" method="post" action="<?= base_url('admin/sarana/edit'); ?>">
                <div class="card-body">
                    <div class="row">

                        <div class="col-md-6">
                            <input type="hidden" name="id_usaha" value="<?= $usaha['id_usaha']; ?>">
                            <input type="hidden" name="id_sarana" value="<?= $usaha['id_sarana']; ?>">
                            <h5>Luas Lahan </h5>
                            <hr />
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label col-form-label-sm">Luas Lahan (m2)</label>
                                <div class="col-sm-8">
                                    <input type="text" name="l_bangunan" class="form-control form-control-sm col-10" value="<?= $usaha['l_bangunan']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="l_parkir" class="form-control form-control-sm col-10" value="<?= $usaha['l_parkir']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="ruang_hijau" class="form-control form-control-sm col-10" value="<?= $usaha['ruang_hijau']; ?>" required>
