...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <form role="form" method="post" action="<?= base_url('admin/genset/edit'); ?>">
                <div class="card-body">
                    <div class="row">
                        <input type="hidden" name="id_usaha" value="<?= $usaha['id_usaha']; ?>">
                        <input type="hidden" name="id_genset" value="<?= $usaha['id_genset']; ?>">


                        <div class="col-md-8">
                            <h5>Edit Data Genset</h5>
                            <hr />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="bhn" class="form-control form-control-sm col-10" value="<?= $usaha['bhn_bkrgent']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="waktu_opr" class="form-control form-control-sm col-10" value="<?= $usaha['wkt_opr']; ?>" required>
