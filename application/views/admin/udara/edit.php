...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <form role="form" method="post" action="<?= base_url('admin/udara/edit'); ?>" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Parameter</h5>
                            ...
                            <input type="hidden" name="id_u" class="form-control form-control-sm col-10" value="<?= $usaha['id_u']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="lokasi" class="form-control form-control-sm col-12" value="<?= $usaha['lokasi_smp']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="parameter" class="form-control form-control-sm col-6" value="<?= $usaha['parameter_u']; ?>">
                            ...
                            <div class="form-group row">
                                <div class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="date1" class="form-control form-control-sm col-6" type="text" name="tahun" value="<?= $usaha['thn_udara']; ?>" readonly="">
