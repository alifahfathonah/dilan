...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <form role="form" method="post" action="<?= base_url('admin/boiler/edit'); ?>">
                <div class="card-body">
                    <div class="row">
                        <input type="hidden" name="id_usaha" value="<?= $usaha['id_usaha']; ?>">
                        <input type="hidden" name="id_boiler" value="<?= $usaha['id_boiler']; ?>">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="kp_boiler" class="form-control form-control-sm col-4" value="<?= $usaha['kp_boiler']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="b_bakar" class="form-control form-control-sm col-10" value="<?= $usaha['b_bakar']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="bentuk" class="form-control form-control-sm col-10" value="<?= $usaha['bentuk']; ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="w_opr" class="form-control form-control-sm col-4" value="<?= $usaha['w_opr']; ?>" required>
