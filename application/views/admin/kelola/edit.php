                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <div class="form-group row field">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="s_dampak" class="form-control form-control-sm col-10" value="<?= $usaha['sumber']; ?>" required>
                            ...
                            <div class="form-group row field">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="j_dampak" class="form-control form-control-sm col-10" value="<?= $usaha['jenis']; ?>" required>
                            ...
                            <div class="form-group field">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        <textarea name="kelola" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?= $usaha['kelola']; ?>"</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group field">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        <textarea id="editor" name="pantau" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?= $usaha['pantau']; ?>"</textarea>
                                    </div>
                                </div>
                            </div>
