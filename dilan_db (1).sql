...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Agu 2019 pada 13.35
...
INSERT INTO `p_air` (`id_p`, `id_usaha`, `tgl_pantau`, `parameter_a`, `bk_mutu`, `h_pantau`, `b1`, `b2`, `b3`) VALUES
(15, 'ush002', '2019-01-08', 'BOD', '85', '60', '60', '', ''),
(16, 'ush002', '2019-01-15', 'COD', '75', '65', '65', '', ''),
(18, 'ush002', '2019-01-15', 'TSS', '100', '76', '76', '', ''),
(19, 'ush002', '2019-02-13', 'BOD', '75', '57', '', '57', ''),
(20, 'ush002', '2019-02-12', 'COD', '85', '60', '', '60', ''),
(21, 'ush002', '2019-02-20', 'TSS', '150', '57', '', '57', ''),
(22, 'ush002', '2019-03-13', 'BOD', '75', '65', '', '', '65'),
(23, 'ush002', '2019-03-20', 'COD', '100', '65', '', '', '65'),
(24, 'ush002', '2018-03-21', 'TSS', '100', '65', '', '', '65');
...
CREATE TABLE `p_b3` (
  ...
  `jml_bfr` varchar(50) NOT NULL,
  `jml_now` varchar(50) NOT NULL,
  `save_tps` varchar(50) NOT NULL,
  `used` varchar(50) NOT NULL,
  `give_3` varchar(50) NOT NULL,
...
INSERT INTO `p_udara` (`id_u`, `id_usaha`, `tgl_pantau`, `parameter_u`, `bk_mutu`, `h_pantau`) VALUES
(0, 'ush002', '2019-08-14', 'CO2', '0.001', '0.001');
...
--
ALTER TABLE `p_air`
  MODIFY `id_p` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
