...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Agu 2019 pada 18.01
...
INSERT INTO `p_air` (`id_p`, `id_usaha`, `tgl_pantau`, `parameter_a`, `bk_mutu`, `h_pantau`) VALUES
(1, 'ush002', '2019-08-05', 'BOD', '75', '60'),
(2, 'ush002', '2019-08-21', 'BOD', '85', '65');
...
--
ALTER TABLE `p_air`
  MODIFY `id_p` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
